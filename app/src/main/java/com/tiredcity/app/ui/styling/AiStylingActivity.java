...
public class AiStylingActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recommendedAdapter = new ProductAdapter(new ArrayList<>());
        recommendedAdapter.setOnProductClickListener(new ProductAdapter.OnProductClickListener() {
            @Override
            public void onProductClick(Product product) {
                Intent intent = new Intent(AiStylingActivity.this, ProductDetailActivity.class);
    ...
    private void setupMenhUI(String menh) {
        ...
        binding.tvMenhSubtitle.setText((zodiac != null && !zodiac.isEmpty()) ? zodiac : getString(R.string.aistyle_menh_tagline));

        binding.layoutColors.removeAllViews();
        float density = getResources().getDisplayMetrics().density;
        int dotSize = (int) (32 * density);
        int strokeColor = ContextCompat.getColor(this, R.color.tc_stroke);
        ...
        for (String colorName : colorNames) {
            ...
            LinearLayout.LayoutParams swatchLp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            ...
            label.setTextColor(ContextCompat.getColor(this, R.color.tc_text_on_dark));
    ...
    private void loadAiStylingTip(String menh, List<Product> products) {
        ...
        GeminiStylist.suggest(menh, colors, productNames, new GeminiStylist.Callback() {
            @Override public void onAdvice(String advice) { runOnUiThread(() -> { if (binding != null) binding.tvStylingTip.setText(advice); }); }
            @Override public void onError() { runOnUiThread(() -> { if (binding != null) binding.tvStylingTip.setText(getString(R.string.aistyle_tip_desc)); }); }
        });
    }

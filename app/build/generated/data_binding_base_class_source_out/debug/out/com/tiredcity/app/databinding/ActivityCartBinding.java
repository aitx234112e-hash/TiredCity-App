...
public final class ActivityCartBinding implements ViewBinding {
  ...
  private ActivityCartBinding(@NonNull LinearLayout rootView, @NonNull Button btnCheckout,
      @NonNull RecyclerView rvCartItems, @NonNull Toolbar toolbar, @NonNull TextView tvTotal) {
  ...
  public static ActivityCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCartBinding((LinearLayout) rootView, btnCheckout, rvCartItems, toolbar,
          tvTotal);
    }

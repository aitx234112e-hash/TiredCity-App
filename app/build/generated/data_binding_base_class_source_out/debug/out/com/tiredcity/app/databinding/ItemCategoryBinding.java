...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull MaterialCardView rootView,
      @NonNull ImageView ivCategoryImage, @NonNull TextView tvCategoryName) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.iv_category_image;
      ImageView ivCategoryImage = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemCategoryBinding((MaterialCardView) rootView, ivCategoryImage, tvCategoryName);
    }

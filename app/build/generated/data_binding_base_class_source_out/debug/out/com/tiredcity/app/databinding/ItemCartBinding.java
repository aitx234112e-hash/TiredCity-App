...
public final class ItemCartBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvProductVariant;
  ...
  private ItemCartBinding(@NonNull MaterialCardView rootView, @NonNull TextView btnDecrease,
      @NonNull TextView btnIncrease, @NonNull ImageButton btnRemove,
      @NonNull ImageView ivProductImage, @NonNull TextView tvProductName,
      @NonNull TextView tvProductVariant, @NonNull TextView tvQuantity,
    ...
    this.tvProductVariant = tvProductVariant;
  ...
  public static ItemCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_product_variant;
      TextView tvProductVariant = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemCartBinding((MaterialCardView) rootView, btnDecrease, btnIncrease, btnRemove,
          ivProductImage, tvProductName, tvProductVariant, tvQuantity, tvSubtotal);
    }
